...
exploreApp.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
     ...
     $stateProvider
        ...
        .state("editShowImage", {
            name: 'editShowImage',
            url:"/editShowImage/:id",
            cache:false,
            reload:true,
            data: {pageTitle: '编辑识别图'},
            templateUrl: "./template/editShowImage/editShowImage.html",
            controller: "editShowImageController",
            resolve: {
