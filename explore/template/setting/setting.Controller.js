    ...
    $scope.$on('$viewContentLoaded', () => {
        ...
        if ( !token ){
            ...
            class User {
                constructor() {}
                getUserInfo(istoken) {
                    serverConnect.__get(baseURL + '/explore/user/get-user-info', {token: istoken}).success(function(data){
                        if (data.code == 200) {
                            $scope.user = {
                ...
                updateUserInfo(isdata) {
                    serverConnect.__post(baseURL + '/explore/user/update-user-setting', isdata, {}).success(function(data) {
                        if (data.code == 200) {
                            layer.msg(data.msg, {
                                time: 800
                            });
                ...
                updateUserPassword(isdata) {
                    serverConnect.__post(baseURL + '/explore/user/update-pwd', isdata, {}).success(function(data) {
                        if (data.code == 200) {
                            layer.msg(data.msg, {
                                time: 800
                            });
