    ...
    $scope.$on('$viewContentLoaded', () => {
        ...
        if ( !token ){
            ...
            class List{
                ...
                getListInfo(istoken){
                    serverConnect.__get(baseURL + '/explore/img-show/get', {token: istoken}).success(function(data){
                    /*serverConnect.__get(baseURL + '/explore/img-show/get', {token: istoken, cn: $scope.pageSize, pn: $scope.page}).success(function(data){*/
                        if(data.code == 200){
                ...
                delList(istoken, isid){
                    ...
                    serverConnect.__post(baseURL + '/explore/img-show/delete', postData, {}).success(function(data){
                        if(data.code == 200){
                            layer.msg('删除成功', {
                                time: 700
                            });
